...
export default function Home() {
  return (
    <section>
      <div >
      <div class="flex space-x-4 absolute top-2 right-3 h-16 w-19 ...">

<a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline mt-4">Create a certificate</a>
<a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline mt-4">My certificate</a>
